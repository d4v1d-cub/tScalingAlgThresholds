...
def main():
    ...
    filein = 'crossings_K_4_quartic.txt'
    fileout = f'fits_K_4_quartic.txt'
    fileout_log = f'fits_K_4_quartic_log.txt'
    fig_costs = f'Costs_fits_K_4_quartic.png'
    fig_costs_log = f'Costs_fits_K_4_quartic_log.png'
