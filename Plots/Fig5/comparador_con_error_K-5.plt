...
p datosL2 u ($1):($2/L2):($4/L2)  	notitle with filledcurves		lc 10 fs transparent solid 0.3 \
...
, datosH2 u ($1):($3/H2)  		title "{/=26 {/Symbol a}=".alphaH2."0"	lc 7	dt 3 lw 3 w l \
, datosH1 u ($1):($3/H1)  		title "{/=26 {/Symbol a}=".alphaH1	lc 7	dt 1 lw 2 w l \
, datosH0 u ($1):($3/H0)  		title "{/=26 {/Symbol a}=".alphaH0	lc 7	dt 1 lw 5 w d \
, referencia u ($1):($2/H0*1.02)  		notitle 				lc 0	dt 3 lw 3 w l \
,datosL0 u ($1):($3/L0)  		title "{/=26 {/Symbol a}=".alphaL0	lc 10	dt 1 lw 5 w d \
,datosL1 u ($1):($3/L1)  		title "{/=26 {/Symbol a}=".alphaL1."0"	lc 10	dt 1 lw 2 w l \
,datosL2 u ($1):($3/L2)  		title "{/=26 {/Symbol a}=".alphaL2."0"	lc 10	dt 3 lw 3 w l  
